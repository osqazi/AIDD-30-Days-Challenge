...
| :--- | :--- | :--- |
| **Phase 1: Constitution** | Define the project-wide standards, rules, constraints, and **non-negotiable quality criteria** for success across all work. | Documented project-wide rules and quality standards. |
...
| **Phase 5: Implementation** | Execute the atomic tasks generated in the previous phase, primarily using the AI with the `/sp.implement` slash command, to generate the **working code**. This phase also generates the **PHRs** (Prompt History Records) as you collaborate with the AI. | Working Code and Prompt History Records (PHRs). |